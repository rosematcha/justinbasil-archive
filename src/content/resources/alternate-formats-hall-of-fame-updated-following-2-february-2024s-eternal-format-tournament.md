...
The Alternate Format Hall of Fame page has been updated with the results of the 2 February 2024 Eternal format tournament.

The tournament's results were as follows:

1. **Guil** - Florges Hand Control
2. **iFly** - Blastoise Water Box
3. **PianoLegPete** - Porygon Box
4. **Kaleidophoenix** - Miraidon ex

Click [here](/league/halloffame) to visit the updated Alternate Format Hall of Fame page and join us next month on March 1st for the next alternate format tournament, this time featuring the Post-Rotation Standard format!
