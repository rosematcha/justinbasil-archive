...
<div class="jb-code-container">
  ...
  <ul> 
    <li class="g"><a href="#froslassex">Froslass ex</a></li>
    <li class="r"><a href="#armarougeex">Armarouge ex</a></li>
    <li class="w"><a href="#garchompex">Garchomp ex</a></li>
    <li class="w"><a href="#tsareenaex">Tsareena ex</a></li>
    <li class="w"><a href="#chienpaoex">Chien-Pao ex with Iron Hands ex</a></li>
    <li class="l"><a href="#mewtwoex">Mewtwo ex</a></li>
    <li class="p"><a href="#ironvaliantex">Iron Valiant ex</a></li>
    <li class="p"><a href="#ironvaliantexrsurshifuvmax">Iron Valiant ex w/ Rapid Strike Urshifu VMAX</a></li>
    <li class="f"><a href="#ursalunav">Ursaluna V w/ Garganacl</a></li>
    <li class="d"><a href="#roaringmoonex">Roaring Moon ex</a></li>    
    <li class="m"><a href="#skeledirgeex">Skeledirge ex</a></li>
...
Evolve Snorunt into Froslass so that it can have its Evanescent Ability active, which makes you flip a coin when Froslass would be Knocked Out. If the result of that coin flip is heads, your opponent will take 1 Prize card less for Knocking Out Froslass. Meanwhile, power up Froslass ex with manual attachments, Raihan, and the Froslass from Chilling Reign, preparing it to use its Frost Bullet attack, which does 140 damage and then puts 20 damage on 1 of your opponent’s Benched Pokémon. Make Froslass ex more difficult to Knock Out with Rigid Band and Kricketune’s Swelling Tune Ability.

### KEY CARDS

- [Froslass ex PAR 3](/translations/sv4#block-yui_3_17_2_1_1691761739470_8809)
- [Froslass CRE 36](https://limitlesstcg.com/cards/CRE/36)
- [Kricketune ASR 10](https://limitlesstcg.com/cards/ASR/10)
- [Rigid Band](https://limitlesstcg.com/cards/MEW/165)
...
Using a combination of manual attachments and Magma Basin together with Armarouge's Fire Off Ability to move the Fire Energy from 1 of your Benched Pokémon to your Active Armarouge ex. Take out your opponent's Active Pokémon using Armarouge ex's Scorching Bazooka attack, which does 40 damage plus 40 more damage for each Fire Energy attached to Armarouge ex.

### KEY CARDS

- [Armarouge ex PAR 27](/translations/sv4#block-yui_3_17_2_1_1692278768447_93601)
- [Armarouge SVI 47](https://limitlesstcg.com/cards/SVI/41)
- [Magma Basin](https://limitlesstcg.com/cards/BRS/144)
...
Evolve Bounsweet up into Tsareena ex with the help of Rare Candy. Using Tsareena ex’s Icicle Sole, put damage counters on 1 of your opponent’s Pokémon until its remaining HP is 30—ideally, you’ll do this to your opponent’s Active Pokémon while you have both a Brute Bonnet with an Ancient Booster Energy Capsule attached and Radiant Hisuian Sneasler in play. With Brute Bonnet’s Toxic Powder and Radiant Hisuian Sneasler’s Poison Peak ability, this four-piece combo will Knock Out even the bulkiest of Pokémon.

### KEY CARDS

- [Tsareena ex PAR 46](/translations/sv4#block-yui_3_17_2_1_1696677386958_248667)
- [Brute Bonnet PAR 123](/translations/sv4#block-yui_3_17_2_1_1691917969584_288226)
- [Radiant Hisuian Sneasler LOR 123](https://limitlesstcg.com/cards/LOR/123)
...
Play down and evolve Natu into Xatu, using Xatu’s Clairvoyant Sense Ability to attach a Psychic Energy card from your hand to 1 of your Benched Pokémon and draw two cards. Attack using Mewtwo ex, Deoxys, or Cresselia as needed to Knock Out your opponent’s Active Pokémon.

### KEY CARDS

- [Mewtwo ex PAR 58](/translations/sv4#block-yui_3_17_2_1_1691838010171_135646)
- [Xatu PAR ??](/translations/sv4#block-yui_3_17_2_1_1693584428444_429225)
...
Spread damage and even take Knock Outs using Iron Valiant ex’s Tachyon Bits Ability, which lets you put 2 damage counters on 1 of your opponent’s Pokémon when Iron Valiant ex moves into the Active Spot. Play down and evolve Natu into Xatu, using Xatu’s Clairvoyant Sense Ability to attach a Psychic Energy card from your hand to 1 of your Benched Pokémon and draw two cards. Attack using Iron Valiant ex’s Laser Blade attack or, once one of your opponent’s Pokémon would be Knocked Out by its Yoga Loop attack, Medicham V, to get an extra turn after taking the Knock Out.

### KEY CARDS

- [Iron Valiant ex PAR 89](/translations/sv4#block-yui_3_17_2_1_1691917969584_216649)
- [Xatu PAR 72](/translations/sv4#block-yui_3_17_2_1_1693584428444_429225)
...
Spread damage and even take Knock Outs using Iron Valiant ex’s Tachyon Bits Ability, which lets you put 2 damage counters on 1 of your opponent’s Pokémon when Iron Valiant ex moves into the Active Spot. Attack using Rapid Strike Urshifu and Rapid Strike Urshifu VMAX, or once one of your opponent’s Pokémon would be Knocked Out by its Yoga Loop attack, Medicham V, to get an extra turn after taking the Knock Out.

### KEY CARDS

- [Iron Valiant ex PAR 89](/translations/sv4#block-yui_3_17_2_1_1691917969584_216649)
- [Rapid Strike Urshifu VMAX BST 88](https://limitlesstcg.com/cards/BST/88)
- [Future Booster Energy Capsule](/translations/sv4#block-yui_3_17_2_1_1693496971996_113191)
...
Bulk up Ursaluna V with the help of Rock Chestplate and Lake Acuity. Heal away damage dealt to Ursaluna V with Penny or with the effect of Garganacl’s Energy Rock Salt Ability, which lets you attach a Basic Fighting Energy card from your discard pile to 1 of your Pokémon and then heal 30 damage from that Pokémon.

### KEY CARDS

- [Ursaluna V SIT 102](https://limitlesstcg.com/cards/SIT/102)
- [Garganacl PAR 104](/translations/sv4#block-yui_3_17_2_1_1697203092813_800304)
...
Using a combination of Earthen Vessel, Dark Patch, and Professor Sada’s Vitality, power up a benched Roaring Moon ex, then switch it into the Active Spot by attaching a Jet Energy to it. Take Knock Outs, as appropriate, by either using Roaring Moon ex’s Frenzied Gouging attack, which instantly Knocks Out your opponent’s Pokémon in exchange for Roaring Moon ex doing 200 damage to itself, Roaring Moon ex’s Calamity Storm, which does 100 damage plus 120 more if you discard a Stadium card in play, or with Brute Bonnet’s Rampaging Hammer, which does 120 damage.
...
Evolve Fuecoco up into Skeledirge ex. Attack with Entei V, Skeledirge ex, or with Radiant Charizard to take Knock Outs and augment your attacker’s damage with Skeledirge ex’s Incendiary Song Ability which, in exchange for discarding a Fire Energy from your hand, boosts the damage of your attacks by 60.

### KEY CARDS

- [Skeledirge ex PAR 137](/translations/sv4#block-yui_3_17_2_1_1691838010171_109459)
- [Entei V BRS 22](https://limitlesstcg.com/cards/BRS/22)
- [Magma Basin](https://limitlesstcg.com/cards/BRS/144)
- [Jet Energy](https://limitlesstcg.com/cards/PAL/190)
...
- [Energy Retrieval](https://limitlesstcg.nyc3.digitaloceanspaces.com/tpci/SVI/SVI_171_R_EN_SM.png)
