...
<div class="jb-code-container">
  ...
  <ul> 
    ...
    <li><a href="#burmy">Burmy Box</a></li>
    <li><a href="#leafeonvmax">Leafeon VMAX w/ Shaymin VSTAR</a></li>
    <li><a href="#durant">Durant</a></li>
    <li><a href="#charizardvstar">Charizard VSTAR</a></li>
    <li><a href="#enteiv">Entei V</a></li>
    <li><a href="#magmortar">Magmortar</a></li>
    <li><a href="#kinglervmax">Kingler VMAX</a></li>
    <li><a href="#raichuv">Raichu V</a></li>
    <li><a href="#flaaffy">Flaaffy Box</a></li>
    <li><a href="#pachirisu">Pachirisu</a></li>
    <li><a href="#malamar">Malamar</a></li>
    <li><a href="#mimikyuvmax">Mimikyu VMAX</a></li>
    <li><a href="#alcremie">Alcremie</a></li>
    <li><a href="#srcalyrexvmax">Shadow Rider Calyrex VMAX w/ Whimsicott VSTAR</a></li>
    <li><a href="#lucario">Lucario</a></li>
    <li><a href="#rayquazavmax">Rayquaza VMAX</a></li>
    <li><a href="#garchomp">Garchomp</a></li>
    <li><a href="#arceusvstar">Arceus VSTAR</a></li>
    <li><a href="#madparty">Mad Party</a></li>
  </ul>
</div>
</div>
...
Bench Turtwig and evolve at least one of them into Grotle. Use Grotle’s Sun-Drenched Shell ability to search for Torterra and, using Rare Candy, evolve Turtwig into Torterra as soon as possible. On turn 1, bench Leafeon V and use its Greening Cells ability to get an extra Grass energy into play. Evolve unevolved Pokémon as soon as possible to increase the damage of Torterra’s Evo Press attack, which does 50 damage for each of your Evolution Pokémon in play.

### KEY CARDS

- [Torterra BRS 8](https://limitlesstcg.com/cards/jp/S9/8?translate=en)
- [Grotle BRS 7](https://limitlesstcg.com/cards/jp/S9/7?translate=en)
- [Leafeon V EVS 7](https://limitlesstcg.com/cards/EVS/7)
- [Exp. Share](https://limitlesstcg.com/cards/en/bst/126)

### OTHER CONSIDERATIONS

- [Cherrim BST 8](https://limitlesstcg.com/cards/bst/8) and its pre-evolution, Cherubi, in place of Leafeon V and Leafeon VSTAR.
...
Evolve Burmy into the most advantageous typing of Wormadam, to hit for Weakness when possible. Use Wormadam's Matron's Anger attack, which does 30 damage plus 10 more for each Pokémon in your discard pile. Use Zoroark's Phantom Transformation to help recycle attackers and to switch into techier attacking options, like Appletun (for dealing with decks that run a lot of Special Energy), Flapple (for dealing with ability-heavy decks), or Golisopod (for dealing with decks that run a lot of Pokémon V).

### KEY CARDS

- Wormadam ([BRS 10](https://limitlesstcg.com/cards/jp/S9/10?translate=en), [77](https://limitlesstcg.com/cards/jp/S9/53?translate=en), and [88](https://limitlesstcg.com/cards/jp/S9/66?translate=en))
...
Bench Leafeon V and use its Greening Cells ability early to attach a Grass Energy to prepare for Leafeon VMAX to use its Grass Knot attack, increasing the damage it deals with Galar Mine and, for Pokémon with retreat cost reducing tools attached to them, use Tool Jammer to shut off the effect of those tools to restore Grass Knot’s full damage. On later turns of the game, use a combination of Raihan and manual attachments to power up Shaymin V or its evolution, Shaymin VSTAR, to take advantage of its Revenge Burst attack, which does 40 more damage for each Prize card your opponent has taken—in addition to the base 40 damage (Shaymin V) or 120 (Shaymin VSTAR).

### KEY CARDS

- [Leafeon V EVS 7](https://limitlesstcg.com/cards/evs/7)
- [Leafeon VMAX EVS 8](https://limitlesstcg.com/cards/evs/8)
- [Leafeon VSTAR PR-SW 195](https://limitlesstcg.com/cards/ssp/195)
- [Shaymin VSTAR BRS 14](https://limitlesstcg.com/cards/jp/S9/13?translate=en)
...
- [Durant BST 10](https://limitlesstcg.com/cards/BST/10)
- [Twin Energy](https://limitlesstcg.com/cards/RCL/174), [Double Turbo Energy](https://limitlesstcg.com/cards/jp/S9/100?translate=en)
...
Evolve Minccino into Cinccino and Charizard V into Charizard VSTAR. Power up your attackers with a combination of Magma Basin, manual attachments, and Raihan, and take knockouts with Charizard VSTAR's Explosive Fire attack, which does 130 damage plus 100 more damage if Charizard VSTAR has any damage on it. Once per game, take a critical KO with its VSTAR Power, Star Blaze, which does 320 damage and discards two energy cards attached to Charizard VSTAR. Use Moltres to setup or finalize knockouts against your opponent’s Pokémon.

### KEY CARDS

- [Charizard V BRS 17](https://limitlesstcg.com/cards/jp/S9/14?translate=en)
- [Charizard VSTAR BRS 18](https://limitlesstcg.com/cards/jp/S9/15?translate=en)
- [Talonflame V VIV 29](https://limitlesstcg.com/cards/VIV/29)
- [Magma Basin](https://limitlesstcg.com/cards/jp/S9/99?translate=en)
...
- [Rare Candy’s version of this archetype](https://www.youtube.com/watch?v=p9mWz0aa-KM)
...
Attack with Entei V’s Burning Rondo attack, which does 20 damage plus 20 more damage for each Benched Pokémon both players have in play. Use Raihan and Magma Basin for quick and easy attachments and attach Heat Fire Energy to push Entei V's HP up just enough to make it much more difficult to knock out easily.

### KEY CARDS

- [Entei V BRS 22](https://limitlesstcg.com/cards/jp/SI/56?translate=en)
- [Talonflame V VIV 29](https://limitlesstcg.com/cards/VIV/29)
- [Magma Basin](https://limitlesstcg.com/cards/jp/S9/99?translate=en)
...
Evolve Magmar into Magmortar, Minccino into Cinccino, and Electabuzz into Electivire. Using Magma Basin and manual attachments, power up Magmortar’s Volt Projection attack, which does 120 damage plus 120 more if Electivire is on your bench.

### KEY CARDS

- [Magmortar BRS 20](https://limitlesstcg.com/cards/jp/S9/17?translate=en)
- [Electivire BRS 47](https://limitlesstcg.com/cards/jp/S9/36?translate=en)
- [Magma Basin](https://limitlesstcg.com/cards/jp/S9/99?translate=en)
...
Use Kingler V’s Falling Bubbles attack, with the help of Glimwood Tangle to reflip if you get tails, or Wailord V’s Draw Up attack to power up Wailord V and its Ocean Waves attack or Kingler VMAX and its G-Max Pincer attack. Use Ocean Waves (again, with Glimwood Tangle to help reflip the coin flips for the attack, if necessary) to take knockouts.

### KEY CARDS

- [Kingler VMAX BRS 29](https://limitlesstcg.com/cards/jp/SI/81?translate=en)
...
Get Raichu V and Mareep into play as early as possible, evolving into Flaaffy as the opportunity presents. Manually Speed Lightning energy to Raichu V as needed to power up its Dynamic Spark attack and use Flaaffy’s Dynamotor ability to attach additional energy to Raichu to finish powering it up or to your Benched Pokémon to increase the damage of Raichu V’s Dynamic Spark attack, which does 60 damage for each Lightning Energy you discard from your Pokémon.

### KEY CARDS

- [Flaaffy BRS 55](https://limitlesstcg.com/cards/EVS/55)
- [Raichu V BRS 45](https://limitlesstcg.com/cards/jp/S9/34?translate=en)
- [Raikou V BRS 48](https://limitlesstcg.com/cards/jp/SI/137?translate=en)
...
Evolve Mareep into Flaaffy, and bench Reshiram and Zekrom, using Tapu Koko as a free-retreating pivot Pokémon. Use Flaafy’s Dynamotor ability to attach Energy to Zekrom to power up its White Thunder attack, which does 80 damage plus 80 more damage if Reshiram is on your bench. Further boost that 160 damage to 190 with Choice Belt, which adds 30 damage against to the damage against active Pokémon V. Use Zapdos to target down damaged or weakened bench Pokémon V on your opponent’s side of play with its Thunder Snipe attack.
...
Attach Energy to Pachirisu to prepare for its Windup Thunder attack, which does 30 damage for each Pokémon Tool card attached to all of your Pokémon. Attach Exp. Share and Lucky Egg to Pachirisu and other tools to Honchkrow V, whose Boss’s Stash ability makes it possible to attach up to 4 Tool cards to it.

### KEY CARDS

- [Pachirisu BRS 52](https://limitlesstcg.com/cards/jp/S9/40?translate=en)
- [Honchkrow V BRS 88](https://limitlesstcg.com/cards/jp/S9/64?translate=en)
...
Set up by benching Inkay, Minccino, and Remoraid, and evolve them as the opportunity presents, using Cinccino’s Make Do ability to draw cards and to thin out non-Rapid Strike cards from your hand. Prepare your hand by grabbing Rapid Strike cards from your deck with Octillery’s Rapid Strike Search, Korrina’s Focus, Cynthia’s Ambition, and Professor’s Research. Take knockouts using Malamar’s Rapid Strike Tentacles attack, which does 40 damage for each Rapid Strike card you shuffle into your deck.
...
Using Arceus V’s Trinity Charge to power up a benched Arceus V or VSTAR and Mimikyu V or VMAX. Take knockouts primarily with Arceus VSTAR’s Trinity Nova attack, continuing to power up your Pokémon V as necessary. Pick off damaged and low-HP Pokémon using Mimikyu VMAX’s Occult Number attack, which places 13 damage counters on your opponent’s Pokémon in any way you like.

### KEY CARDS

- [Arceus V BRS 122](https://limitlesstcg.com/cards/jp/S9/83?translate=en)
- [Arceus VSTAR BRS 123](https://limitlesstcg.com/cards/jp/S9/84?translate=en)
- [Mimikyu VMAX BRS 69](https://limitlesstcg.com/cards/jp/S8b/77?translate=en)
- [Acerola’s Premonition](https://limitlesstcg.com/cards/jp/S8b/148?translate=en)
- [Double Turbo Energy](https://limitlesstcg.com/cards/jp/S9/100?translate=en)
...
Evolve Milcery into Alcremie, Bidoof into Bibarel, and Swablu into Altaria. Using Altaria’s ability search for and place Café Master on the top of your deck, then use Bibarel to draw into it. With Alcremie in the Active Spot, play Café Master and load up your Pokémon with Energy via its effect and manual attachments. Attack using Alcremie’s Rainbow of Flavor attack, which does 10 damage plus 40 damage for each type of basic Energy attached to your Pokémon.

### KEY CARDS

- [Alcremie BRS 71](https://limitlesstcg.com/cards/jp/S8b/81?translate=en)
- [Bibarel BRS 121](https://limitlesstcg.com/cards/jp/S9/82?translate=en)
- [Altaria EVS 106](https://limitlesstcg.com/cards/en/evs/106)
- [Café Master](https://limitlesstcg.com/cards/jp/S8b/159?translate=en)
...
Bench and evolve Shadow Rider Calyrex V into Shadow Rider Calyrex VMAX to make full use of its Underworld Door ability, which not only attaches a Psychic Energy from your hand to one of your benched Psychic Pokémon, it draws two cards when you do. Use either Shadow Rider Calyrex VMAX’s Max Geist attack or Whimsicott VSTAR’s Fluffball Star attack to take knockouts or slow down your opponent with Whimsicott VSTAR’s Trick Wind attack, which makes your opponent unable to play and Tool or Special Energy cards from their hand.

### KEY CARDS

- [Shadow Rider Calyrex VMAX CRE 75](https://limitlesstcg.com/cards/CRE/75)
- [Galarian Articuno EVS 63](https://limitlesstcg.com/cards/EVS/63)
- [Whimsicott VSTAR BRS 65](https://limitlesstcg.com/cards/jp/S9/50?translate=en)
...
Evolve Riolu into Lucario and use its Roaring Resolve ability to attach a Fighting Energy from your deck to Lucario. Use a combination of manual attachments, Raihan, Roaring Resolves paired with Energy Switches to boost the number of Energy attached to Lucario, then use its Aura Sphere Volley which does 10 damage plus 60 more damage for each Fighting Energy you discard from Lucario.

### KEY CARDS

- [Lucario BRS 79](https://limitlesstcg.com/cards/jp/S9/55?translate=en)
- [Raihan](https://limitlesstcg.com/cards/EVS/152)
...
- [Rayquaza V EVS 110](https://limitlesstcg.com/cards/evs/110/)
- [Rayquaza VMAX 111](https://limitlesstcg.com/cards/EVS/111/)
...
Evolve Gible into Garchomp using Rare Candy (or by manually evolving it from Gabite), taking advantage of its Sonic Slip ability, which makes it immune to all damage and all effects of the attacks of your opponent’s Pokémon, to ensure that Garchomp survives two or more turns. Use Garchomp’s Dragonblade attack, which does 160 damage for 1 Water and 1 Fighting Energy, but discards the top two cards from your deck.

### KEY CARDS

- [Garchomp BRS 109](https://limitlesstcg.com/cards/jp/S9/75?translate=en)
...
Use Arceus V’s Trinity Charge attack to power up the deck’s partner of choice. Evolve Arceus V into Arceus VSTAR, using Trinity Nova to take knock outs and its Starbirth VSTAR Power to get any two cards from your deck when you need them. Use another Arceus VSTAR or the deck’s other attackers to clean up what is left of your opponent’s field after Arceus VSTAR is knocked out.
...
- [Dark Arceus, Rainbow Arceus] [Pumpkaboo EVS 76](https://limitlesstcg.com/cards/EVS/76) or additional Stadium cards to get the deck out of a Path to the Peak-based ability lock.
- Cram Arceus VSTAR into basically any existing archetype, competitive or otherwise, that focuses on a Pokémon V or VMAX, and watch the deck improve.

</div><div class="jb-col-6"><div class="jb-code-container">
<div class="RKS_tab">
  <button id="arceus_open" class="arceus_tabs">Dark Box</button>
  <button class="arceus_tabs">Ice Rider</button>
  <button class="arceus_tabs">Shadow Rider</button>
  <button class="arceus_tabs">Rainbow</button>
  <button class="arceus_tabs">Duraludon</button>
  <button class="arceus_tabs">Rayquaza</button>
...
- [[Arceus VSTAR / Rapid Strike Urshifu VMAX] Celio’s Network](https://www.youtube.com/watch?v=eGQLRP7luOY)
- [[Dark Arceus VSTAR] Celio’s Network](https://www.youtube.com/watch?v=Lbvo-POaBHw)
...
Bench Bunnelby and, using the deck’s means various of discarding Pokémon with the Mad Party attack (Ultra Ball, Quick Ball, Allister, Professor’s Research, Galarian Articuno V’s Reconstitute ability, and Polteageist’s Tea Break ability), fill up your discard pile with those Pokémon. Attach Twin Energy or, as necessary, Double Turbo Energy to power up Bunnelby’s Mad Party attack and take knockouts against your opponent’s Pokémon.
