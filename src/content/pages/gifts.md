...
<div class="jb-code-container">
  ...
  <ul> 
    <li><a href="#battledecks">Battle Decks</a></li>
    <li><a href="#battleacademy">Pokémon Battle Academy</a></li>
    <li><a href="#lbd">League Battle Decks</a></li>
    <li><a href="#etb">Elite Trainer Boxes</a></li>
    <li><a href="#toolkit">Trainer's Toolkit</a></li>
    <li><a href="#boosters">Booster Packs</a></li>
    <li><a href="#sleeves">Deck Sleeves</a></li>
    <li><a href="#deckboxes">Deck Boxes</a></li>
    <li><a href="#binders">Trade or Collection Binders</a></li>
    <li><a href="#pennysleeves">Perfect Fit and Penny Sleeves</a></li>
    <li><a href="#cards">Individual Cards</a></li>
    <li><a href="#tins">Tins</a></li>
    <li><a href="#collections">Pokémon Collection Boxes</a></li>
  </ul>
</div>
</div>
...
Booster packs and single-pack blister packs sell for $4-5, three-pack blister packs sell for $12-15, and booster boxes range in price from $160-180 for a more recent set up to $500-600 for a set from several years ago.
...
- [TCG Player Gift Cards](https://shop.tcgplayer.com/giftcard) (United States)
- [eBay Gift Cards](https://www.ebay.com/b/eBay-Gift-Cards/172036/bn_7208216)
