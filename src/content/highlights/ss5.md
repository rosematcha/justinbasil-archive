...
<h1 class="jb-center">Highlights from Battle Styles</h1>

To review this set’s full card list, visit the article [Battle Styles—What We Know So Far](/set-lists/ss5).
...
Cherrim’s *Spring Bloom* ability is reminiscent of previous <em>Rain Dance-</em>like abilities like *Deluge* on Blastoise from Black & White—Boundaries Crossed. Although Cherrim will likely be most useful after Fire archetypes lose Welder and Giant Hearth in the upcoming rotation, Cherrim looks to be a significant boost to single prize archetypes that can make use of Basic Grass Energy.
...
Cheating in evolution Pokémon, including Pokémon VMAX and Stage 1 or 2 Pokémon can be quite a powerful trick, though your deck must be built to accommodate it. Decks like Blastoise BCR have used similar cards before—like [Archie’s Ace in the Hole](https://limitlesstcg.com/cards/PRC/124/)—with varying degrees of success. What’s more, Single Strike Stance Mustard searches your *deck* for the Pokémon you’re cheating into play, making it even easier to pull off the crazy combo needed to make this Mustard card work. Like Rapid Strike Stance Mustard, even if this card doesn’t take off immediately, it’s always worth keeping in mind as more cards are introduced that could make it even more likely to find success.
