...
<table width="300px" class="jb-center-block">
  <tbody><tr bgcolor="#b7d8bd">
    ...
    <tr>
          ...
          <div class="jb-left">
              <ul>
            <li>1 Fezandipiti ex SFA 38</li>    
          </ul>
              </div>
    </td>
  </tr><tr bgcolor="#b7c6d8">
    <td class="jb-th">Trainer Cards - 29</td>
  </tr>
      <tr><td align="left">
        <ul>
          <li>4 Arven OBF 186</li>
          <li>4 Iono PAL 185</li>
          <li>2 Boss's Orders PAL 172</li>
          <li>4 Nest Ball SVI 181</li>
          <li>4 Ultra Ball SVI 196</li>
          <li>4 Buddy-Buddy Poffin TEF 144</li>
          <li>2 Earthen Vessel PAR 163</li>
          <li>2 Night Stretcher SFA 61</li>
...
- 4 copies of the Basic Pokémon
  - Note: If your main attacker is a Basic Pokémon, or if the Basic Pokémon that your main attacker evolves from has more than 70HP, you should cut the 4 Buddy-Buddy Poffin from your deck.
...
- 4 copies of [Rare Candy](https://limitlesstcg.com/cards?q=Rare%20Candy)
