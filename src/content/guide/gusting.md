...
**Leafeon VSTAR PR-SW 195** is a gusting option that has a VSTAR Power—<em>Ivy Star—</em>that can be used when it is needed. It is, in effect, a Boss’s Orders but without the need to use it as your Supporter card for the turn.
