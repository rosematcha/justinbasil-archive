...
When referring to specific cards, this guide makes use of the standard **Set Abbreviations**. You can see a list of these abbreviations in [Appendix I: Set Symbols and Abbreviations](/guide/appendix1).
